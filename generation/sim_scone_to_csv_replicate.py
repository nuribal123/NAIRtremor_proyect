...
if __name__ == "__main__":
    output_dir = os.path.join("..", "data", "data_replicate_raw")
    base_lua = "controllers/NewMatsuoka6_template.lua"
    base_scone = "data/H0918_S2_template.scone"

    seeds = list(range(7000))  # Número de simulaciones a lanzar
