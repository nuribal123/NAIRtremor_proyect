...
import sys
sys.path.append("C:\\Program Files\\SCONE\\scone\\scenarios\\SconePy")
...
def run_simulation_wrapper(args):
    ...
    try:
        ...
        delay_src = "data/neural_delays_FEA_v4.zml"
...
if __name__ == "__main__":
    ...
    base_lua = "controllers/NewMatsuoka4_templatetry_frecOrig.lua"
    base_scone = "data/H2190_template.scone"

    seeds = list(range(0, 1))  # Number of simulations to launch
    args = [(seed, output_dir, base_lua, base_scone) for seed in seeds]

    #A. To debug the code (without multiprocessing) uncomment the following code and use intead of B
    #for seed_args in args:
    #    run_simulation_wrapper(seed_args)

    #B. Con multiprocessing to paralelize
