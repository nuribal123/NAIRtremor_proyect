...
def run_simulation_wrapper(args):
    ...
    try:
        ...
        rng = np.random.default_rng(seed)
        base_freq = rng.uniform(0.181, 0.414) #0.182
        h_value = rng.uniform(2.2, 2.5) #estaba en 2.2 a 2.4...
...
def run_simulation(model, store_data, random_seed, output_dir, file_id, max_time=4): #antes puesto en 6
    ...
    with open(csv_path, "w", newline="") as file:
        ...
        for t in np.arange(0, max_time, 0.01667): #Frecuencia de muestreo de 60Hz como es con los IMUs
...
if __name__ == "__main__":
    ...
    #output_dir = "D:/ingenieriabiomedica/sconeGym/sconegym/sim_data_MATSUOKA6at60Hz_sinsconethings" 
    output_dir = "D:/ingenieriabiomedica/sconeGym/sconegym/sim_data_MATSUOKA6at60Hz_sinsconethings_amplitude"
    ...
    seeds = list(range(0, 9000))  # Número de simulaciones a lanzar
