# como el anterior pero cambiando el controlador para mejor ajuste de la frecuencia
...
def run_simulation_wrapper(args):
    ...
    try:
        ...
        rng = np.random.default_rng(seed)
        base_freq = rng.uniform(0.183, 0.419) #antes de 2.75 a 4.83, después 2.05, 5.33
        #base_freq = rng.uniform(0.948, 2.133)
...
def run_simulation(model, store_data, random_seed, output_dir, file_id, max_time=6):
    ...
    with open(csv_path, "w", newline="") as file:
        ...
        if store_data:
            dirname = 'sconepy_sim_data_01_05_2024_4_9_2_' + model.name()
...
if __name__ == "__main__":
    output_dir = "D:/ingenieriabiomedica/sconeGym/sconegym/sim_data_03_05_2025_4_9_valoresKf0183_0419" #contaminado :(, se ha vuelto a poner hasta la sim 22...
    #output_dir = "D:/ingenieriabiomedica/sconeGym/sconegym/sim_data_03_05_2025_4_9_valoresKf0948_2133"
    base_lua = "C:/Users/balba/OneDrive/Documentos/SCONE/Tutorials/controllers/NewMatsuoka4_templatetry_frecOrig.lua" #antes con NewMatsuoka3_template3?, NewMatsuoka4_template.lua
    #base_scone = "D:/ingenieriabiomedica/sconeGym/sconegym/sconegym/data/H0918_S2_template.scone" #se mantiene el mismo
    base_scone = "D:/ingenieriabiomedica/sconeGym/sconegym/sconegym/data/H2190_template.scone"

    seeds = list(range(200, 250))  # Número de simulaciones a lanzar
