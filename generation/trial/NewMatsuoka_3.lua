...
function init(model, par)
    ...
    -- La frecuencia base se obtiene de 0.20295625594446448 (entre 4 y 9Hz)
    base_freq = 0.20295625594446448
    ...
    x1 = 0.08564916714362436
    v1 = 0.2368105065960997
    x2 = 0.8012744652063969
    v2 = 0.5821620360643678
end
