...
function init(model, par)
    ...
    -- La frecuencia base se obtiene de 0.3314120731458988 (entre 4 y 9Hz)
    base_freq = 0.3314120731458988
    ...
    x1 = 0.6369616873214543
    v1 = 0.2697867137638703
    x2 = 0.04097352393619469
    v2 = 0.016527635528529094
end
