...
function init(model, par)
    ...
    -- La frecuencia base se obtiene de 0.3022544385551598 (entre 4 y 9Hz)
    base_freq = 0.3022544385551598
    ...
    x1 = 0.5118216247002567
    v1 = 0.9504636963259353
    x2 = 0.14415961271963373
    v2 = 0.9486494471372439
end
