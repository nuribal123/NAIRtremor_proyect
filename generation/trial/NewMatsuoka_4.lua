...
function init(model, par)
    ...
    -- La frecuencia base se obtiene de 0.40273207259836163 (entre 4 y 9Hz)
    base_freq = 0.40273207259836163

    tau1 = 0.1
    tau2 = 0.1
    beta = 2.4
    -- La amplitud base se fija con 2.5; para mantener cambios sutiles,
    ...
    x1 = 0.9430561055723676
    v1 = 0.5113275528143616
    x2 = 0.9762437057077041
    v2 = 0.08083602389560218
end
